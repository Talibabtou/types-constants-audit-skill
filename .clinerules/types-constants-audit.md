...
Use this rule when auditing TypeScript type files, constant files, literal unions, enum-like values, magic strings/numbers, stale exports, or shared vs feature-local placement.
